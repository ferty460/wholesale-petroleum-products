...
* The original package name 'com.example.order-accounting' is invalid and this project uses 'com.example.orderaccounting' instead.
...
* [Mustache](https://docs.spring.io/spring-boot/docs/2.7.12/reference/htmlsingle/#web.servlet.spring-mvc.template-engines)
